...
import br.com.m4u.sms.api.app.service.injection.PostgreUnitOfWork;
...
import br.com.m4u.sms.api.domain.services.SmsMessageServiceImpl;
...
public class SmsEndpoint {
	...
	public Response send(SendSmsRequest sendSmsRequest) {
		...
		try (UnitOfWork unitOfWork = new br.com.m4u.sms.api.persistence.postgre.PostgreUnitOfWork()){
			
			Result<SmsMessage> resultEnvelop = new SmsMessageServiceImpl(unitOfWork).sendStoringSmsMessage(convertToSmsMessage(sendSmsRequest));
